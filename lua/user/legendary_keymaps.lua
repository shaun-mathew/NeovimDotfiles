...
legendary.setup({
    keymaps = {
        ...
        {"<A-h>", ":require('smart-splits').resize_left()<CR>", description = "Resize window pane to the left", opts = opts},
        {"<A-j>", ":require('smart-splits').resize_down()<CR>", description = "Resize window pane down", opts = opts},
        {"<A-k>", ":require('smart-splits').resize_up()<CR>", description = "Resize window pane up", opts = opts},
        {"<A-l>", ":require('smart-splits').resize_right()<CR>", description = "Resize window pane to the right", opts = opts},
